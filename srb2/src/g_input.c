...
void G_Controldefault(void)
{
	...
	gamecontrol[gc_fire       ][0] = KEY_SPACE; //Y
	gamecontrol[gc_scores     ][0] = KEY_LSHIFT; //X
	gamecontrol[gc_jump       ][0] = KEY_LCTRL; //A
	gamecontrol[gc_use        ][0] = KEY_LALT; //B
	gamecontrol[gc_camleft    ][0] = KEY_TAB; //L
	gamecontrol[gc_camright   ][0] = KEY_BACKSPACE; //R
