...
*/
    ...
    //SDL_Flip(sdl_video.surf_screen);
    {
      ...
      int x, y;
      uint32_t *s = (uint32_t*)sdl_video.surf_screen->pixels;
...
*/
  ...
  ScreenSurface = SDL_SetVideoMode(320, 480, 16, vidflags);
  sdl_video.surf_screen = SDL_CreateRGBSurface(SDL_SWSURFACE, 320, 240, 16, 0, 0, 0, 0);
...
*/
	  ...
	  case 51: //menu is now using SDKL_HOME
			menu();
			break;
    case SDLK_F4:
    case SDLK_F5:
