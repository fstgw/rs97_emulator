//**************************************************************************
//**
//** $Id: i_sdl.c 467 2009-05-25 21:30:25Z sezero $
//**
//**************************************************************************
...
//	memset(pcscreen, 255, SCREENHEIGHT*SCREENWIDTH);
    ...
    SDL_Surface* p = SDL_ConvertSurface(sdl_screen, ScreenSurface->format, 0);
...
void I_InitGraphics(void)
{
  ...
  sdl_screen = SDL_CreateRGBSurface(SDL_SWSURFACE, SCREENWIDTH, SCREENHEIGHT, 8, 0, 0, 0, 0);
