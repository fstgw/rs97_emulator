...
printf("load_input_port_settings()\n");
...
static int vh_open(void)
{
	...
	/* This calls out to osd_create_display() */
	printf("artwork_create_display()\n");
