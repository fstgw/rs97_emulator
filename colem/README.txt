    ...
    Welcome to GP2X-Colem - 1.1.0

Original Author of ColEm

  Marat Fayzullin

Author of the PSP, GP2X and WIZ ports versions
...
4. LOADING COLECOVISION ROM FILES
  ...
  file (with .zip, or .rom file extension) on your GP2X SD card in the 'rom'
  directory.
  
  Then, while inside GP2XColem emulator, just press Start to enter in the
...
----------
  ...
  You can use cheat codes with GP2XColem You can add your own cheat codes in
...
------------
  ...
  Clock frequency : 
    ...
    to 300Mhz, and should be enough for most of all
    games.
...
10. COMPILATION
  ...
  It has been developped under Linux FC9 using gcc with GP2X-SDK. 
  All tests have been done using a GP2X-F100 with FW 4.1
